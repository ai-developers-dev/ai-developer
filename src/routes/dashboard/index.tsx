...
function DashboardOverview() {
  ...
  const statusBadge = (status: string) => {
    switch (status) {
      case 'new':
        return <Badge className="bg-blue-500/10 text-blue-300 hover:bg-blue-500/10 border-blue-500/30">New</Badge>
      case 'contacted':
        return <Badge className="bg-amber-500/10 text-amber-300 hover:bg-amber-500/10 border-amber-500/30">Contacted</Badge>
      case 'quoted':
        return <Badge className="bg-purple-500/10 text-purple-300 hover:bg-purple-500/10 border-purple-500/30">Quoted</Badge>
      case 'converted':
        return <Badge className="bg-green-500/10 text-green-300 hover:bg-green-500/10 border-green-500/30">Converted</Badge>
      case 'archived':
